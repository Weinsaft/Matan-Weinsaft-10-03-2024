...
const MovieDisplay = ({ movie, onClick }) => {
  ...
  return (
    <div className="container d-flex justify-content-center flex-column pb-5 gap-3 z-n1">
      <div className="d-flex justify-content-between align-items-center align-items-sm-end pb-3 flex-column flex-sm-row z-n1">
      ...
      <div className="row gap-4 justify-content-center">
            {parseActors().map((actor) => (
              <div key={actor.Title} className="col-10 col-md-2 d-flex justify-content-center align-items-center actor-card bg-dark py-3  text-center card">
